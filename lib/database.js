...
class Database {
  constructor (options) {
    ...
    this.options.timestamps = Object.assign({}, defaultTimestamps, options.timestamps)
    ...
    this._scripts = scripts.load(this, this.options.scriptDir)
  ...
  async init () {
    ...
    this._columns = results.reduce((total, row) => {
      ...
      const encrypted = Object.prototype.hasOwnProperty.call(this.options.encrypt, key)
    ...
    for (const table of this._tables) {
      ...
      if (Object.prototype.hasOwnProperty.call(this.options.timestamps, table)) {
