...
class Database {
  constructor (options) {
    ...
    this.options.timestamps = Object.assign({}, defaultTimestamps, this.options.timestamps)
  ...
  async init () {
    ...
    for (const table of this._tables) {
      this[table] = new Table(this._db, table, this._columns[table], this._scripts[table], this.options.cipher, this.options.timestamps)
    }
  }
